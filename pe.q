...
/Large non-Mersenne prime                                             \t 24
/  (1+28433*2 xexp 7830457) is equivalent to 1+28433*2*(16777216 xexp 509)xexp 641
p097:{
 a:16777216; k:0;
 while[k<508; a:floor((1e0*(a*6)mod 1e10)+(1e1*a mod 1e9)+(1e2*(a*2)mod 1e8)+(1e3*(a*7)mod 1e7)+(1e4*(a*7)mod 1e6) +(1e5*(a*7)mod 1e5)+(1e6*(a*6)mod 1e4)+(1e7*a mod 1e3))mod 1e10; k+:1];
 k:0; b:a; c:pDfi[10;a];
...
p206:{
 ...
 c:b[where 8=floor((b*b)mod 10e4)%10e3];   / where square ends in 8_9
 d:raze c+/:\:floor 10e3*til 100;          /last 6 digits
 e:d[where 7=floor((d*d)mod 10e6)%10e5];   / where square ends in 7_8_9
 f:raze e+/:\:floor 10e5*til 100;          /last 8 digits
 g:f[where 6=floor((f*f)mod 10e8)%10e7];   / where square ends in 6_7_8_9
 ...
 j:i[where 5=floor((i*i)mod 10e10)%10e9];  / where square ends in 5_6_7_8_9
 k:j[where 4=floor((j*j)mod 10e12)%10e11]; / where square ends in 4_5_6_7_8_9
 l:k[where 3=floor((k*k)mod 10e14)%10e13]; / where square ends in 3_4_5_6_7_8_9
 m:l[where 2=floor((l*l)mod 10e16)%10e15]; / where square ends in 2_3_4_5_6_7_8_9
 n:m[where 1=floor((m*m)mod 10e18)%10e17]; / where square ends in 1_2_3_4_5_6_7_8_9
 "j"$first n}
